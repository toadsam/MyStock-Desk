...
- Backend: Java 17, Spring Boot, Spring Web, Spring Data JPA, Validation, Lombok
...
StockFlow는 실제 투자/주문 서비스가 아닙니다. 모든 포트폴리오, 뉴스, 주가, AI 분석, 주문/체결 데이터는 데모용 가상 데이터입니다. 결제, 실명인증, 계좌연동, 민감정보 입력, 실제 매수/매도 기능은 구현하지 않았습니다.
